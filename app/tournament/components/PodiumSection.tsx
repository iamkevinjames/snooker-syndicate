...
export default function PodiumSection({
  ...
  return (
    <section className="print-shell print-page-section print-break-inside-avoid print-order-podium mt-8 rounded-3xl border border-green-800/30 bg-[radial-gradient(circle_at_top,#2d3f19_0%,#162018_38%,#111d15_100%)] p-4 sm:p-6 lg:p-8 print:mt-4 print:p-3">
